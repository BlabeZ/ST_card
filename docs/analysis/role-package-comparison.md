...
对照材料：`sillytavernassets-main/cards/萝莉/` 的角色卡、世界书、多开局和状态机制

分析日期：2026-08-27

## 范围与方法

本次对比检查了八张角色卡、发行世界书、Quick Reply、安装文档、开发源、构建器和现有测试。第三方目录只用于比较产品形态和实现方法，不采用其中的未成年人性化内容。
...
第三方重点目录的完整结构分析见 [`cards-loli-analysis.md`](cards-loli-analysis.md)。
